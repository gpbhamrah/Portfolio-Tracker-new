    ...
    <div className="space-y-3">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-3 px-1">
        ...
        <div className="text-[11px] font-mono text-slate-400">
          FILTERED: <span className="font-bold text-indigo-400">{filteredAndSortedHoldings.length}</span> / {holdings.length} POSITIONS
        </div>
      </div>
          ...
          <thead>
            <tr className="bg-slate-900 border-b border-slate-800 text-[10px] font-bold text-slate-500 uppercase tracking-widest select-none">
              <th
                ...
                className="p-3.5 cursor-pointer hover:bg-slate-800 transition group"
              >
              ...
              <th
                ...
                className="p-3.5 cursor-pointer hover:bg-slate-800 transition group hidden md:table-cell"
              >
                <div className="flex items-center gap-1.5">
                  <span>Sector</span>
              ...
              <th
                ...
                className="p-3.5 cursor-pointer hover:bg-slate-800 transition group text-right"
              >
            ...
            {filteredAndSortedHoldings.map((item) => {
              ...
              return (
                ...
                >
                    ...
                    {editingDateId === item.id ? (
                      <div className="flex items-center gap-1.5">
                        <input
                          ...
                          className="text-xs p-1 rounded border border-indigo-500 bg-slate-800 text-white focus:outline-none font-mono"
                        />
                        <button
                      ...
                      >
                        <div className="font-medium text-slate-200 flex items-center gap-1 font-mono">
                          <span>{formatDate(item.buyDate)}</span>
                          <Calendar className="w-3 h-3 text-slate-500 opacity-0 group-hover/date:opacity-100 transition" />
                        </div>
                        <div className="flex items-center gap-1.5 mt-0.5 font-mono">
                  ...
                  {/* Quantity */}
                  <td className="p-3.5 text-right font-medium text-slate-200 font-mono">
                    {item.qty}
                  </td>
                  ...
                  <td className="p-3.5 text-center hidden lg:table-cell">
                    {isStopLoss ? (
                      <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded text-[11px] font-bold font-mono bg-rose-950/80 text-rose-300 border border-rose-800">
                      ...
                      <span className="inline-flex items-center px-2 py-0.5 rounded text-[11px] font-mono bg-slate-800 text-slate-400 border border-slate-700">
                        HOLDING
                      </span>
                    )}
                  </td>
